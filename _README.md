# DEOS - a cryptocurrency implementation in less than 1500 lines of code

[![Build Status](https://travis-ci.org/conradoqg/deos.svg?branch=master)](https://travis-ci.org/conradoqg/deos) [![Coverage Status](https://coveralls.io/repos/github/conradoqg/deos/badge.svg?branch=master)](https://coveralls.io/github/conradoqg/deos?branch=master)
...
It's the starting point to interact with the deos, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
# Run two nodes
$ node bin/deos.js -p 3001 --name 1
$ node bin/deos.js -p 3002 --name 2 --peers http://localhost:3001
...
# Run deos in a docker
$ ./dockerExec.sh

# Run deos in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run deos in a docker options
$ ./dockerExec.sh -h
...
```sh
# Clonning repository
$ git clone git@github.com:conradoqg/deos.git
$ cd deos
$ npm install
...
[![Twitter](https://img.shields.io/twitter/url/https/github.com/conradoqg/deos.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20it%20out%3A%20DEOS%20-%20a%20cryptocurrency%20implementation%20in%20less%20than%201500%20lines%20of%20code&url=%5Bobject%20Object%5D)

[![GitHub license](https://img.shields.io/badge/license-Apache%202-blue.svg)](https://raw.githubusercontent.com/conradoqg/deos/master/LICENSE)
